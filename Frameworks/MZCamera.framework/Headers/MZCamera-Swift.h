...
- (void)cameraWithFacade:(CameraFacade * _Nonnull)facade didLeaveCurrentUser:(MZPeerInfo * _Nonnull)peer;
- (void)cameraWithDidConnectToServer:(CameraFacade * _Nonnull)facade;
- (void)cameraWithDidDisconnectFromServer:(CameraFacade * _Nonnull)facade;
- (void)cameraWithFacade:(CameraFacade * _Nonnull)facade didUpdateVideo:(BOOL)enable peer:(MZPeerInfo * _Nonnull)peer;
- (void)cameraWithFacade:(CameraFacade * _Nonnull)facade didReceive:(NSString * _Nonnull)limitMessage;
- (void)cameraWithFacade:(CameraFacade * _Nonnull)facade peer:(MZPeerInfo * _Nonnull)peer didReceive:(id <RoomMediaStream> _Nonnull)mediaStream;
- (void)trafficStateChanged:(TrafficMonitor * _Nonnull)monitor;
- (void)trafficStatisticChange:(TrafficSummary * _Nonnull)summary;
- (void)trafficNetworkChange:(TrafficAlert * _Nonnull)alert;
@end
